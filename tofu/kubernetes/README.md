...
**Bitwarden Secrets Manager** - Edit bws.auto.tfvars and set varibles bws_access_token_ro(env: TF_VAR_bws_access_token_ro) and bws_access_token_rw(env: TF_VAR_bws_access_token_rw)
