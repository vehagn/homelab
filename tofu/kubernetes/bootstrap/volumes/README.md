...
```shell
tofu import 'module.volumes.module.persistent-volume["pv-sonarr"].kubernetes_persistent_volume_v1.pv' pv-sonarr
tofu import 'module.volumes.module.persistent-volume["pv-radarr"].kubernetes_persistent_volume_v1.pv' pv-radarr
tofu import 'module.volumes.module.persistent-volume["pv-lidarr"].kubernetes_persistent_volume_v1.pv' pv-lidarr
tofu import 'module.volumes.module.persistent-volume["pv-prowlarr"].kubernetes_persistent_volume_v1.pv' pv-prowlarr
tofu import 'module.volumes.module.persistent-volume["pv-torrent"].kubernetes_persistent_volume_v1.pv' pv-torrent
tofu import 'module.volumes.module.persistent-volume["pv-remark42"].kubernetes_persistent_volume_v1.pv' pv-remark42
tofu import 'module.volumes.module.persistent-volume["pv-authelia-postgres"].kubernetes_persistent_volume_v1.pv' pv-authelia-postgres
tofu import 'module.volumes.module.persistent-volume["pv-lldap-postgres"].kubernetes_persistent_volume_v1.pv' pv-lldap-postgres
tofu import 'module.volumes.module.persistent-volume["pv-keycloak-postgres"].kubernetes_persistent_volume_v1.pv' pv-keycloak-postgres
tofu import 'module.volumes.module.persistent-volume["pv-jellyfin-config"].kubernetes_persistent_volume_v1.pv' pv-jellyfin-config
tofu import 'module.volumes.module.persistent-volume["pv-netbird-signal"].kubernetes_persistent_volume_v1.pv' pv-netbird-signal
tofu import 'module.volumes.module.persistent-volume["pv-netbird-management"].kubernetes_persistent_volume_v1.pv' pv-netbird-management
tofu import 'module.volumes.module.persistent-volume["pv-plex"].kubernetes_persistent_volume_v1.pv' pv-plex
tofu import 'module.volumes.module.persistent-volume["pv-prometheus"].kubernetes_persistent_volume_v1.pv' pv-prometheus
```
